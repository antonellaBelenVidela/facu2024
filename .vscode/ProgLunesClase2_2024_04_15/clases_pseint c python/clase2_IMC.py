...
print  ("|Peso bajo                   <18.50                    |")
print  ("|     Delgadez severa            <16.00                |")
print  ("|     Delgadez moderada          16.00-16.99           |")
print  ("|     Delgadez leve              17.00-18.49           |")
print  ("|Normal                      18.50-24.99               |")
print  ("|Sobrepeso                   >=25.00                   |")
print  ("|     Preobesidad                25.00-29.99           |")
print  ("|     Obesidad                   >=30.00               |")
print  ("|          leve                      30.00-34.99       |")
print  ("|          media                     35.00-39.99       |")
print  ("|          morbida                   40.00             |")
...
#peso <- 80
#Leer peso
peso= input  ("Por favor ingrese su peso:") # siempre es un string
peso = float(peso)

#altura <- 1.80
#Leer altura
altura = input ("Por favor ingrese su altura:")# siempre es un string
altura = float(altura)
...
imc = peso / (altura*altura)
print  ( "su IMC es ", imc)
print  ( "a partir de un peso de  ", peso)
print  ( "y de una altura de ", altura)
