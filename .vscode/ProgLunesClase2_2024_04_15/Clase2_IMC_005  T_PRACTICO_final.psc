...
//------------------------------------------------------------------	
	...
	//------------------------------------------------------------------
	//                               condicion de salida
	Si imc >= 25 Entonces// de 25 a infinito +
		Escribir "Sobrepeso ";
		si imc >= 30
			Escribir "        Obesidad ";
			si imc >= 40
		...
		FinSi
	SiNo 
		Si imc >= 18.5 Entonces//desde 18.8 a 25
			escribir "Peso Normal";
		sino  
			Escribir "Peso bajo";// los datos que no llega a 18.5
			si imc < 16 Entonces
			...
			SiNo
				...
				sino
					escribir "Delgadez leve";				//			Delgadez leve              17.00-18.49
